            ...
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('manufacturing.items.index') }}">Items</a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <dl class="row">
                            ...
                            <dd class="col-7">
                                <a href="{{ route('manufacturing.item-categories.show', $item->itemCategory) }}" class="badge bg-blue-lt">
                    ...
                    <div class="table-responsive">
                        <table class="table table-vcenter card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <a href="{{ route('manufacturing.warehouses.show', $positionItem->shelfPosition->warehouseShelf->warehouse) }}" class="text-reset">
