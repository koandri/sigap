            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('manufacturing.yield-guidelines.index') }}" class="btn btn-outline-secondary">
                        ...
                        <span class="d-none d-sm-inline">Back to Guidelines</span>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="from_item_id" id="from_item_id" class="form-select @error('from_item_id') is-invalid @enderror" required>
                                            ...
                                            <option value="{{ $id }}" data-stage="adonan" {{ old('from_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                            @foreach($gelondonganItems as $id => $label)
                                            <option value="{{ $id }}" data-stage="gelondongan" {{ old('from_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                            @foreach($kerupukKgItems as $id => $label)
                                            <option value="{{ $id }}" data-stage="kerupuk_kg" {{ old('from_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                        @error('from_item_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="to_item_id" id="to_item_id" class="form-select @error('to_item_id') is-invalid @enderror" required>
                                            ...
                                            @foreach($gelondonganItems as $id => $label)
                                            <option value="{{ $id }}" data-stage="gelondongan" {{ old('to_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                            @foreach($kerupukKgItems as $id => $label)
                                            <option value="{{ $id }}" data-stage="kerupuk_kg" {{ old('to_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                            @foreach($kerupukPackItems as $id => $label)
                                            <option value="{{ $id }}" data-stage="packing" {{ old('to_item_id') == $id ? 'selected' : '' }}>{{ $label }}</option>
                                            @endforeach
                                        </select>
                                        @error('to_item_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
