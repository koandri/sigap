                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('manufacturing.item-categories.show', $category) }}" class="btn btn-sm btn-outline-primary">
                                                View
                                            </a>
                                            <a href="{{ route('manufacturing.item-categories.edit', $category) }}" class="btn btn-sm btn-outline-secondary">
                                                Edit
                                            </a>
                                            @if($category->items_count == 0)
                                            <form method="POST" action="{{ route('manufacturing.item-categories.destroy', $category) }}" style="display: inline;">
                                                @csrf
                                                @method('DELETE')
