...
<head>
    ...
    <title>JC/RO Kerupuk Kg - {{ $plan->plan_date->format('d M Y') }}</title>
    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">JC/RO Kerupuk Kg</h2>
                </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="document-header">
                <div class="document-title">JOB COSTING & ROLL OVER KERUPUK KG</div>
                ...
                <div style="margin-top: 10px; padding: 10px; background-color: #e3f2fd; border: 2px solid #2196f3; border-radius: 5px; font-weight: bold; color: #1976d2;">
                    <i class="far fa-info-circle me-2"></i>BERDASARKAN PRODUKSI AKTUAL (Step 3 Selesai)
                </div>
                @else
                <div style="margin-top: 10px; padding: 10px; background-color: #fff3e0; border: 2px solid #ff9800; border-radius: 5px; font-weight: bold; color: #f57c00;">
                    <i class="far fa-info-circle me-2"></i>BERDASARKAN RENCANA PRODUKSI (Step 3 Belum Selesai)
                </div>
                @endif
            </div>
            ...
            <div class="mt-4">
                ...
                <h4 class="mb-3">Gelondongan yang Digunakan untuk Memproduksi Kerupuk Kg</h4>
                    <table>
                        <thead>
                            <tr>
                                <th>No</th>
                        ...
                        <tbody>
                            @forelse($jcData['gelondongan'] ?? [] as $index => $item)
                            <tr>
            ...
            <div class="mt-5">
                ...
                <h4 class="mb-3">Kerupuk Kg yang Diproduksi</h4>
                    <table>
                        <thead>
                            <tr>
                                <th>No</th>
                        ...
                        <tbody>
                            @forelse($roData['kerupukKg'] ?? [] as $index => $item)
                            <tr>
                                <td class="text-center">{{ $index + 1 }}</td>
                                <td class="barcode-cell">
                                    @if($item['item']->accurate_id)
