...
<head>
    ...
    <title>Surat Perintah Kerja Produksi Kering - {{ $plan->plan_date->format('d M Y') }}</title>
    ...
    <div class="page-header d-print-none">
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    <h2 class="page-title">Surat Perintah Kerja Produksi Kering</h2>
                </div>
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="document-header">
                <div class="document-title">SURAT PERINTAH KERJA PRODUKSI KERING</div>
            ...
            <h3 class="mt-4 mb-3">Kerupuk Pack yang Diproduksi</h3>
            <table>
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    @forelse($kerupukPack as $index => $item)
                    <tr>
                        <td class="text-center">{{ $index + 1 }}</td>
                        <td>{{ $item['item']->name }}</td>
                        <td class="text-right">{{ number_format($item['quantity'], 0) }}</td>
            ...
            <h3 class="mt-4 mb-3">Bahan Kemasan yang Digunakan</h3>
            <table>
                <thead>
                    <tr>
                        <th>No</th>
                ...
                <tbody>
                    @forelse($packingMaterials as $index => $material)
                    <tr>
                        <td class="text-center">{{ $index + 1 }}</td>
