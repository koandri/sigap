...
<style>
    ...
    /* Only make the ingredients table responsive container allow overflow for dropdown */
    #ingredients-table + .form-hint,
    #ingredients-table ~ .form-hint {
        /* Keep table responsive for scrolling, but allow dropdown to escape */
    }
...
<div class="page-body">
    <div class="container-xl">
        ...
        <form method="POST" action="{{ route('manufacturing.recipes.store') }}" id="recipe-form">
            @csrf
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                               name="name" value="{{ old('name') }}" placeholder="Enter recipe name" maxlength="100" required>
                                        @error('name')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          name="description" rows="3" placeholder="Optional description for this recipe">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-footer text-end">
                            <a href="{{ route('manufacturing.recipes.index') }}" class="btn btn-link">Cancel</a>
...
function initTomSelects() {
    ...
    // Initialize first ingredient select
    initializeIngredientSelect(0);
}
