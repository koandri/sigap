    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('manufacturing.recipes.show', $recipe) }}" class="btn btn-outline-secondary">
                        <i class="far fa-arrow-left"></i>&nbsp;
                        <span class="d-none d-sm-inline">Back to Recipe</span>
                                        ...
                                        <tr class="ingredient-row">
                                            <td>
                                                <select name="ingredients[{{ $index }}][ingredient_item_id]" class="form-select ingredient-item-select" id="ingredient-item-select-{{ $index }}" required>
                                                    ...
                                                    <option value="{{ $id }}" {{ $ingredient->ingredient_item_id == $id ? 'selected' : '' }}>
                                                        {{ $label }}
                                                    </option>
                                                    @empty
