    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('options.items.index') }}" class="btn btn-outline-secondary">
        ...
        <div class="row row-deck row-cards">
            <div class="col-md-8 col-lg-10">
                ...
                <div class="card">
                    ...
                    <form method="POST" action="{{ route('options.items.update', $item) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <a href="{{ route('options.items.index') }}" class="btn btn-link">Cancel</a>
