    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('options.item-categories.index') }}">Item Categories</a></li>
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('options.item-categories.edit', $itemCategory) }}" class="btn btn-primary">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <a href="{{ route('options.items.index') }}?category={{ $itemCategory->id }}" class="btn btn-outline-primary w-100">
                                    <i class="far fa-list"></i>&nbsp;
                                    View All Items
                                </a>
                            </div>
                            <div class="col-md-4 mb-3">
                                <a href="{{ route('options.item-categories.edit', $itemCategory) }}" class="btn btn-outline-secondary w-100">
                                    <i class="far fa-edit"></i>&nbsp;
                                    Edit Category
                                </a>
                            </div>
                            <div class="col-md-4 mb-3">
                                <a href="{{ route('options.item-categories.index') }}" class="btn btn-outline-secondary w-100">
