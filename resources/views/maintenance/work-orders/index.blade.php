    ...
    <div class="container-xl">
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-calendar-alt me-2"></i>Upcoming Maintenance Schedules (Next 14 Days)
                </h3>
                                        ...
                                        @if(!$existingWO)
                                            ...
                                            <form action="{{ route('maintenance.schedules.trigger', $schedule) }}" method="POST" class="d-inline">
                                                ...
                                                <button type="submit" class="btn btn-sm btn-primary" title="Generate Work Order Now">
                                                    <i class="fas fa-plus me-1"></i>Create WO
                                                </button>
                                            </form>
                                            @endcan
                                        @else
        ...
        <div class="card mb-3">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-filter me-2"></i>Filter Work Orders
                </h3>
            </div>
            <div class="card-body">
                <form method="GET">
