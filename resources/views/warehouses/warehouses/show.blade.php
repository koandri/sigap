    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.warehouses.shelf-inventory', $warehouse) }}" class="btn btn-outline-success">
                        <i class="far fa-th-large me-2"></i>&nbsp;
                        Manage Inventory
                    </a>
                    <a href="{{ route('warehouses.warehouses.bulk-edit', $warehouse) }}" class="btn btn-outline-warning">
                        <i class="far fa-edit me-2"></i>&nbsp;
                        Bulk Edit
                    </a>
                    <a href="{{ route('warehouses.warehouses.shelf-management', $warehouse) }}" class="btn btn-outline-info">
                        <i class="far fa-layer-group me-2"></i>&nbsp;
                        Manage Shelves
                    </a>
                    <a href="{{ route('warehouses.warehouses.edit', $warehouse) }}" class="btn btn-primary">
                        <i class="far fa-edit me-2"></i>&nbsp;
                        Edit Warehouse
                    </a>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-actions">
                            <a href="{{ route('warehouses.warehouses.shelf-inventory', $warehouse) }}" class="btn btn-primary btn-sm">
                                <i class="far fa-th-large me-2"></i>&nbsp;
                                Manage Inventory
                            </a>
                        </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3 mb-3">
                                <a href="{{ route('warehouses.warehouses.shelf-inventory', $warehouse) }}" class="btn btn-outline-primary w-100">
                                    <i class="far fa-th-large"></i>&nbsp;
                                    Manage Inventory
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="{{ route('warehouses.warehouses.bulk-edit', $warehouse) }}" class="btn btn-outline-warning w-100">
                                    <i class="far fa-edit"></i>&nbsp;
                                    Bulk Edit
                                </a>
                            </div>
                            <div class="col-md-3 mb-3">
                                <a href="{{ route('warehouses.warehouses.edit', $warehouse) }}" class="btn btn-outline-secondary w-100">
                                    <i class="far fa-edit"></i>&nbsp;
                                    Edit Warehouse
                                </a>
                            </div>
