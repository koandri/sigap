    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.warehouses.shelf.create', $warehouse) }}" class="btn btn-primary">
                        <i class="far fa-plus me-2"></i>&nbsp;
                        Add Shelf
                    </a>
                    <a href="{{ route('warehouses.warehouses.show', $warehouse) }}" class="btn btn-outline-secondary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('warehouses.warehouses.shelf-positions', [$warehouse, $shelf]) }}" class="btn btn-sm btn-outline-primary">
                                                <i class="far fa-th-large me-1"></i>&nbsp;
                                                Positions
                                            </a>
                                            <a href="{{ route('warehouses.warehouses.shelf.edit', [$warehouse, $shelf]) }}" class="btn btn-sm btn-outline-secondary">
                                                <i class="far fa-edit me-1"></i>&nbsp;
                                                Edit
                                            </a>
                                            <form action="{{ route('warehouses.warehouses.shelf.destroy', [$warehouse, $shelf]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this shelf? This action cannot be undone.')">
                                                @csrf
                                                @method('DELETE')
