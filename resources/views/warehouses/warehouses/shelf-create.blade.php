...
@section('title', 'Create Shelf: ' . $warehouse->name)
    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.warehouses.shelf-management', $warehouse) }}" class="btn btn-outline-secondary">
...
<div class="page-body">
    <div class="container-xl">
        ...
        <form action="{{ route('warehouses.warehouses.shelf.store', $warehouse) }}" method="POST">
            @csrf
                ...
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('shelf_code') is-invalid @enderror" 
                                               name="shelf_code" value="{{ old('shelf_code') }}" 
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('shelf_name') is-invalid @enderror" 
                                               name="shelf_name" value="{{ old('shelf_name') }}" 
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control @error('description') is-invalid @enderror" 
                                          name="description" rows="3" placeholder="Describe the shelf purpose and what it stores...">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('max_capacity') is-invalid @enderror" 
                                       name="max_capacity" value="{{ old('max_capacity', 5) }}" 
                        ...
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <a href="{{ route('warehouses.warehouses.shelf-management', $warehouse) }}" class="btn btn-link">Cancel</a>
