...
<div class="page-body">
    <div class="container-xl">
        ...
        <form action="{{ route('warehouses.warehouses.update', $warehouse) }}" method="POST">
            @csrf
            @method('PUT')
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-footer text-end">
                            <div class="d-flex">
                                <a href="{{ route('warehouses.warehouses.show', $warehouse) }}" class="btn btn-outline-secondary me-auto">Cancel</a>
