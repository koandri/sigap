    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.overview-report.print', request()->query()) }}" target="_blank" class="btn btn-primary print-button">
                        <i class="far fa-print me-2"></i>&nbsp;
                        Print Report
                    </a>
                    <a href="{{ route('warehouses.warehouses.index') }}" class="btn btn-outline-secondary">
...
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="filter-section">
            ...
            <form method="GET" action="{{ route('warehouses.overview-report') }}" class="row g-3">
                <div class="col-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="{{ route('warehouses.overview-report') }}" class="btn btn-outline-secondary">
