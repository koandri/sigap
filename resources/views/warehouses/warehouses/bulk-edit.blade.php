...
<div class="page-wrapper">
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <!-- Bulk Operations -->
            <form method="POST" action="{{ route('warehouses.warehouses.bulk-update', $warehouse) }}" id="bulk-operations-form">
                @csrf
...
$(document).ready(function() {
    ...
    function loadAisleCount(aisle) {
        $.ajax({
            url: '{{ route("warehouses.warehouses.aisle-positions", [$warehouse, "AISLE"]) }}'.replace('AISLE', aisle),
            method: 'GET',
    ...
    function loadAisle(aisle) {
        ...
        const url = '{{ route("warehouses.warehouses.aisle-positions", [$warehouse, "AISLE"]) }}'.replace('AISLE', aisle);
    ...
    function createPositionRowHtml(position, shelfCode) {
        ...
        return `
            <tr class="position-row" data-position-id="${position.id}" data-aisle="${position.aisle}" data-shelf="${shelfCode}">
                ...
                <td>
                    <form method="POST" action="{{ route('warehouses.warehouses.bulk-update', $warehouse) }}" 
    ...
    function saveAllChanges() {
        ...
        $.ajax({
            url: '{{ route("warehouses.warehouses.save-all-changes", $warehouse) }}',
            method: 'POST',
            data: {
