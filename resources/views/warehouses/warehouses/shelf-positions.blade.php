    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.warehouses.position.create', [$warehouse, $shelf]) }}" class="btn btn-primary">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-list flex-nowrap">
                                            <a href="{{ route('warehouses.warehouses.position.edit', [$warehouse, $shelf, $position]) }}" class="btn btn-sm btn-outline-secondary">
                                                <i class="far fa-edit me-1"></i>&nbsp;
                                                Edit
                                            </a>
                                            <form action="{{ route('warehouses.warehouses.position.destroy', [$warehouse, $shelf, $position]) }}" method="POST" class="d-inline" onsubmit="return confirm('Are you sure you want to delete this position? This action cannot be undone.')">
                                                @csrf
                                                @method('DELETE')
