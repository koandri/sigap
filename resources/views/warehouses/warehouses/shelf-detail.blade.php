    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            <div class="col">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('warehouses.warehouses.shelf-inventory', $warehouse) }}">Shelf Inventory</a></li>
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <a href="{{ route('warehouses.warehouses.shelf-inventory', $warehouse) }}" class="btn">
                        ...
                        <div class="position-card {{ $position->is_occupied ? 'occupied' : 'empty' }}">
                            ...
                            @if($position->is_occupied)
                                ...
                                <div class="item-actions">
                                    ...
                                    <form action="{{ route('warehouses.warehouses.position-item.remove', [$warehouse, $item]) }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.edit-item-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('editItemForm').action = `{{ route('warehouses.warehouses.position-item.update', [$warehouse, 'ITEM_ID']) }}`.replace('ITEM_ID', itemId);
    ...
    document.querySelectorAll('.move-item-btn').forEach(button => {
        button.addEventListener('click', function() {
            ...
            // Set the form action
            document.getElementById('moveItemForm').action = `{{ route('warehouses.warehouses.position-item.move', [$warehouse, 'ITEM_ID']) }}`.replace('ITEM_ID', itemId);
    ...
    function loadAvailablePositions(itemId, currentPositionId) {
        ...
        fetch(`{{ route('warehouses.warehouses.position-item.available-positions', [$warehouse, 'ITEM_ID']) }}`.replace('ITEM_ID', itemId))
    ...
    document.getElementById('addItemForm').addEventListener('submit', function(e) {
        ...
        if (selectedPosition) {
            this.action = `{{ route('warehouses.warehouses.position.add-item', [$warehouse, 'POSITION_ID']) }}`.replace('POSITION_ID', positionId);
        }
    });
