...
return new class extends Migration
{
    ...
    {
        Schema::create('production_actual_step4', function (Blueprint $table) {
            $table->id();
            ...
            $table->integer('actual_qty_gl1_packing')->default(0);
            $table->decimal('actual_qty_gl2_kg', 10, 2)->default(0);
            $table->integer('actual_qty_gl2_packing')->default(0);
            $table->decimal('actual_qty_ta_kg', 10, 2)->default(0);
            $table->integer('actual_qty_ta_packing')->default(0);
            $table->decimal('actual_qty_bl_kg', 10, 2)->default(0);
            $table->integer('actual_qty_bl_packing')->default(0);
    ...
    {
        Schema::dropIfExists('production_actual_step4');
    }
};
