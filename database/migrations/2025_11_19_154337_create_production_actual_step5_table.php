...
return new class extends Migration
{
    ...
    {
        Schema::create('production_actual_step5', function (Blueprint $table) {
            $table->id();
            $table->foreignId('production_actual_id')->constrained('production_actuals')->onDelete('cascade');
            $table->foreignId('production_plan_step5_id')->constrained('production_plan_step5')->onDelete('cascade');
            ...
            $table->integer('actual_quantity_total')->default(0);
            $table->timestamp('recorded_at');
            $table->timestamps();

            $table->index('production_actual_id');
            $table->index('production_plan_step5_id');
    ...
    {
        Schema::dropIfExists('production_actual_step5');
    }
};
